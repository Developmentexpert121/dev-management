<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <a class="nav-link" href='{{url("employee/project/team/$project_id/sprints")}}'>
        <i class="fa fa-print"></i>&nbsp;
        <span class="menu-title">Sprints</span>
      </a>

      <a class="nav-link" href='{{url("employee/project/team/$project_id/createissue")}}'>
        <i class="fa fa-map"></i>&nbsp;
        <span class="menu-title">Create Issue</span>
      </a>

      <a class="nav-link" href='{{url("employee/project/team/$project_id/backlog")}}'>
        <i class="fa fa-bars"></i>&nbsp;
        <span class="menu-title">Backlog</span>
      </a>

      <a class="nav-link" href='{{url("employee/project/team/$project_id/board")}}'>
        <i class="fa fa-bars"></i>&nbsp;
