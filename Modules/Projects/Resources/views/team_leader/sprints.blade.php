            ...
            <?php
              ...
              foreach($sprints as $key => $data)
              {
                ...
                <tr> 
                    ...
                    <td>
                      <a href="<?php echo url('team_leader/project/sprint/create_issue/'.$project_id.'/'.$data->id) ?>">Create Issue</a>
                    </td>
                    <td>{{ucfirst($data->create_project_user)}}  ({{$data->role}})</td>

                    <td> 
                       
                    <a href="<?php echo url('team_leader/project/edit_sprint/'.$project_id.'/'.$data->id) ?>"><i class="fa fa-pencil" title="Edit"></i></a>
                    <a href="<?php echo url('team_leader/project/team/delete_sprint/'.$project_id.'/'.$data->id) ?>" onclick="return confirm('Are you sure you want delete?')"><i class="fa fa-trash-o fa-lg"></i></a>
