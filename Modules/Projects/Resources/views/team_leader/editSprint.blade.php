        ...
        <div class="col-md-12">
          <div class="card rounded-3">
            <div class="card-body p-4">
              <h4 class="text-left">Edit Sprints </h4> 
                
              <form class="row align-items-center" action="<?php echo url('admin/project/team/sprints/edit/'.$allSprint_dit_val['id']) ?>" method='post'>
