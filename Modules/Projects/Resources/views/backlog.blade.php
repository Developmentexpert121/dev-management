                ...
                <div class="modal fade" id="edit{{$data->id}}" role="dialog">
                    ...
                    <div class="modal-dialog"> 
                      ...
                      <div class="modal-content">
                        ...
                        <form class="row align-items-center" action="http://127.0.0.1:8000/projects/team/edit/blackLogIssue/{{$data->id}}" method="post" data-parsley-validate="parsley">
                          <input type="hidden" name="_token" id="csrf" value="<?php echo csrf_token(); ?>">
              ...
              <div class="modal fade" id="delete{{$data->id}}" role="dialog">
                  ...
                  <div class="modal-dialog"> 
                    ...
                    <div class="modal-content">
                      ...
                      <form class="row align-items-center" action="http://127.0.0.1:8000/projects/team/delete/blackLogIssue/{{$data->id}}" method="post" data-parsley-validate="parsley">
                      <input type="hidden" name="_token" id="csrf" value="<?php echo csrf_token(); ?>">
