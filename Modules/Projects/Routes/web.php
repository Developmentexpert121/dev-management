...
Route::prefix('projects')->group(function() 
{
    ...
    Route::post('team/create/issue/updateted','Projects2Controller@update_issue');  
...
{  
	...
	Route::get('project/team/{id}/createissue','Projects2Controller@createissue')->middleware('CheckRole');
