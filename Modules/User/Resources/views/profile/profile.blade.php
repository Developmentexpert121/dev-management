...
<div class="container emp-profile">
            ...
            <div class="row">
                <div class="col-md-4 mb-2">
                    ...
                    <img id="image_preview_container"   src="{{ asset('user/images/' . $profiledata->image)}}"  alt="preview image" style="max-height: 90px;">
                    <?php }else{ ?> 
                     <img id="image_preview_container"  src="{{asset('user/images/default.png')}}"  alt="preview image" style="max-height: 90px;">
                <?php } ?> 
